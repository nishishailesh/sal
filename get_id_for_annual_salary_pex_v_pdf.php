...
head();
menu($link);
echo '<form target=_blank method=post action=annual_salary_pex_v_pdf.php>
         <div class="container" >
		     <div class="row">
...
echo	'<tr>';
echo 		'<td>Font size:<input style="width: 50px;" name=fontsize type=number value=8></td><td colspan="2">
				<input type=submit  class="btn btn-success" name=action value=print_annual_salary>';
echo 			'<input type=submit  class="btn btn-success" formaction=export_annual_salary.php name=action value=export_annual_salary>
					</td>';
echo 	'</tr>';
